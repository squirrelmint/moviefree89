...
class Clip_Model extends Model
{
    ...
    protected $live_stream = 'av_livestream';
    ...
    public function get_category($branch_id) // เรียก Category ตาม Branch 
    {
        $sql = "SELECT
            *
            ...
            WHERE
            $this->table_category.branch_id = 2 AND 
            $this->table_category.category_type = 'cl'
    ...
    public function get_list_video($branchid, $keyword = "", $page = 1)
    {
        ...
        if ($keyword != "") {
            ...
            `$this->table_movie`.movie_enname, `$this->table_movie`.movie_year ), \"'\", \"\'\") LIKE '%$keyword%' ";
        }
