...
{
	public $serviceUrl  = 'http://service.varietyphp.com/';
	//public $serviceUrl  = 'http://backend.cartoonmanga.com/';
	/*
	|--------------------------------------------------------------------------
	| Base Site URL
	|--------------------------------------------------------------------------
	...
	|
	*/
	// public $baseURL = 'http://backend.aegistrex1.com';
		public $baseURL = 'http://localhost:9220/backend/public';
