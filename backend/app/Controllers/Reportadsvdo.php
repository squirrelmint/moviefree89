...
use App\Models\Reportadsvdo_Model;

class Reportadsvdo extends Controller
{
    protected $validation;
    protected $reportadsvdoModel;
    protected $session;
    protected $baseUrl;
	...
	public function __construct() {
        ...
        $this->reportadsvdoModel = new Reportadsvdo_Model();
	...
	public function index($branch, $search=""){
        ...
        $creport = $this->reportadsvdoModel->get_countreportads($branch, $datestart, $dateend);
        ...
        $clreport = $this->reportadsvdoModel->get_countreportads($branch, $dlstart, $dlend);
        if( !empty($clreport) ){ $clreport = $clreport['cads']; }

        $report = $this->reportadsvdoModel->get_reportads($branch, $datestart, $dateend);
        $chartcr = $this->reportadsvdoModel->get_chart_on_month($branch, $datestart, $dateend);
        $chartlm = $this->reportadsvdoModel->get_chart_on_month($branch, $dlstart, $dlend);
		...
		echo view('reportadsvdo/index', $data);
