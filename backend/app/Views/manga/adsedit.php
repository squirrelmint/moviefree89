<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal form-validate-jquery" method="post" enctype="multipart/form-data" action="/mangaads/branch/<?= $branch_id ?>/saveedit/id/<?= $ads_id ?>">
            ...
            <div class="text-right">
                <button type="reset" class="btn btn-default" id="reset">ยกเลิก <i class="icon-reload-alt position-right"></i></button>
