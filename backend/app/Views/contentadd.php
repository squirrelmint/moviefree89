...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal form-validate-jquery" action="<?= base_url(('/content/branch/' . $branch . '/content/saveadd')) ?>" method="POST" enctype="multipart/form-data">
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-lg-8">
                        <div class="form-group">
                            <input type="text" name="txthead" autocomplete="off" class="form-control" required="required" placeholder="">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-lg-9">
                        <img id="TMPimg" src="" height="130px;">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-lg-3">Img Content<span class="text-danger">*</span></label>
                    <div class="input-group col-lg-9">
                        <input type="file" onchange="FileChangeSRC(this)" id="thumbnail" name="thumbnail" required accept=".png, .jpg" class="file-styled-primary">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-lg-9">
                        <textarea rows="5" id="editor" name="ckeditor"></textarea>
                    </div>
                </div>
