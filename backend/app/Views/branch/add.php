<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <form id="formaddbranch" class="form-horizontal form-validate-jquery" method="post" action="/branch/saveadd" enctype="multipart/form-data">
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="branch_name" id="branch_name" autocomplete="off" class="form-control" required="required" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <select name="branch_system" class="form-control">
